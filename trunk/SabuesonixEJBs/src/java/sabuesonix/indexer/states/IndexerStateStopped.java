...
/**
 * IndexerStateStopped class.
 * Busico, Marcelo (marcelobusico@gmail.com)
 * Funes, Franco (funesfranco@gmail.com)
 * Zilocchi, Emiliano (ezilocchi@gmail.com)
 * @version September/2008
 */
public class IndexerStateStopped implements IndexerState {
     ...
     */
    public void start() {
        new Thread(Indexer.getInstance()).start();
    }
     ...
     */
    public void stop() {
        throw new IllegalStateException("The indexer was aleready stopped.");
    }
}
